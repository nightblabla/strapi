...
export interface ApiCasestudyCasestudy extends Schema.CollectionType {
  ...
  attributes: {
    ...
    values: Attribute.Component<'tittle-desc-row.values', true>;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    restorants: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::restorant.restorant'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiCommunityCommunity extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    community_image_url: Attribute.Component<
      'community-image-url.community-image-url',
      true
    >;
    background_image: Attribute.Media;
...
export interface ApiConnectUsConnectUs extends Schema.SingleType {
  collectionName: 'connect_uses';
  info: {
  ...
  attributes: {
    ...
    contact_info: Attribute.Component<'contact-info.contact-information', true>;
    background_image: Attribute.Media;
    tittle: Attribute.String;
    blog: Attribute.Component<'blog-info.blog'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::connect-us.connect-us',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiEnhanceinnovationMetologyEnhanceinnovationMetology
  extends Schema.CollectionType {
  collectionName: 'enhanceinnovation_metologies';
  info: {
    singularName: 'enhanceinnovation-metology';
    pluralName: 'enhanceinnovation-metologies';
    displayName: 'enhanceinnovation_metology';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    metologies: Attribute.Component<'metology-info.metology', true>;
    innovations: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::enhanceinnovation-metology.enhanceinnovation-metology',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    tittle: Attribute.String;
    background_image: Attribute.Media;
    tittle_desc_row: Attribute.Component<
      'tittle-desc-row.tittle-desc-row',
      true
    >;
    culture_page: Attribute.Component<'culture-info.culture-component'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    ...
    background_image: Attribute.Media;
    desc: Attribute.Blocks;
    jobs: Attribute.Component<'job-info.oppenings', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPortfolioPortfolio extends Schema.CollectionType {
  ...
  attributes: {
    company: Attribute.Component<'company-info.company', true>;
    formule_of_success: Attribute.Blocks;
    image: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiRestorantRestorant extends Schema.CollectionType {
  collectionName: 'restorants';
  info: {
    singularName: 'restorant';
    pluralName: 'restorants';
    displayName: 'restorant';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Desc: Attribute.Blocks;
    Image: Attribute.Media;
    Openninghours: Attribute.Component<'rasturant-info.opening-hours'>;
...
export interface ApiStudioPageStudioPage extends Schema.SingleType {
  collectionName: 'studio_pages';
  info: {
    singularName: 'studio-page';
    pluralName: 'studio-pages';
    displayName: 'StudioPage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    title: Attribute.String;
    image: Attribute.Media;
    history: Attribute.Component<'textdate-info.history-text', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::connect-us.connect-us': ApiConnectUsConnectUs;
      ...
      'api::restorant.restorant': ApiRestorantRestorant;
